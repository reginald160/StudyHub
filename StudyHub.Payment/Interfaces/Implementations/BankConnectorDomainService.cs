...
{
   public class BankConnectorDomainService : IBankConnectorDomainService
    {
        public BankConnectorDomainService()
        {
        ...
        /// <returns></returns>
        public Task<PaymentOrderResult> TransmitPaymentOrderAsync(decimal amount, string currencyCode, CardInformation sourceCreditCardInformation,
